...
if(isset($_GET["id"])){
	...
	$sql = "select * from dyski where ID = '$id'";
	...
	echo "<div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-2 h4 font-weight-normal'><b>Pojemność:</b> $wynik[Pojemnosc]</p>
            
            <p class='p-0 m-2 h4 font-weight-normal'><b>Interfejs:</b> $wynik[Interfejs]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Szybkość zapisu:</b> $wynik[SzybkoscZapisu]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Szybkość odczytu:</b> $wynik[SzybkoscOdczytu]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Format:</b> $wynik[Format]</p>
...
if(isset($_GET["typ"])){
$typ = $_GET["typ"];
$sql = "select * from dyski where Typ='$typ'";
$query = mysqli_query($conn, $sql);
while($wynik = mysqli_fetch_assoc($query)){
	echo "<div class='col-md-12 col-sm-12 mr-0 ml-0'><a href='dyski.php?id=".$wynik['ID']."' class='text-decoration-none row border text-dark border-info shadow rounded mr-2 ml-2'>
         ...
         <div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-0'><b>Pojemnosc:</b> $wynik[Pojemnosc]</p>
