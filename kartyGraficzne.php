...
if(isset($_GET["id"])){
	...
	$sql = "select * from kartygraficzne where ID = '$id'";
	...
	echo "<div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-2 h4 font-weight-normal'><b>Typ złącza:</b> $wynik[TypZlacza]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Typ pamięci:</b> $wynik[TypPamieci]</p>
            
            <p class='p-0 m-2 h4 font-weight-normal'><b>Taktowanie rdzenia:</b> $wynik[TaktowanieRdzenia]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Taktowanie pamięci:</b> $wynik[TaktowaniePamieci]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Wielkość pamięci:</b> $wynik[WielkoscPamieci]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Zalecana moc:</b> $wynik[ZalecanaMoc]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Rodzaje wejść/wyjść:</b> $wynik[RodzajeIO]</p>
...
$sql = "select * from kartygraficzne";
$query = mysqli_query($conn, $sql);
while($wynik = mysqli_fetch_assoc($query)){
	echo "<div class='col-md-12 col-sm-12 mr-0 ml-0'><a href='kartyGraficzne.php?id=".$wynik['ID']."' class='text-decoration-none row border text-dark border-info shadow rounded mr-2 ml-2'>
         ...
         <div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-0'><b>Wielkość pamięci:</b> $wynik[WielkoscPamieci]</p>
            
            <p class='p-0 m-0'><b>Taktowanie:</b> $wynik[TaktowaniePamieci]</p>
