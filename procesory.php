...
if(isset($_GET["id"])){
	...
	$sql = "select * from procesory where ID = '$id'";
	...
	echo "<div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-2 h4 font-weight-normal'><b>Ilość rdzeni:</b> $wynik[IloscRdzeni]</p>
            
            <p class='p-0 m-2 h4 font-weight-normal'><b>Taktowanie:</b> $wynik[Taktowanie]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Taktowanie w trybie Turbo:</b> $wynik[TaktowanieTurbo]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Socket:</b> $wynik[Socket]</p>
...
$sql = "select * from procesory where Producent='$producent'";
$query = mysqli_query($conn, $sql);
while($wynik = mysqli_fetch_assoc($query)){
	echo "<div class='col-md-12 col-sm-12 mr-0 ml-0'><a href='procesory.php?id=".$wynik['ID']."' class='text-decoration-none row border text-dark border-info shadow rounded mr-2 ml-2'>
         ...
         <div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
			...
			<p class='p-0 m-0'><b>Taktowanie:</b> $wynik[Taktowanie]</p>
