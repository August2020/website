...
if(isset($_GET["id"])){
	...
	$sql = "select * from ramy where ID = '$id'";
	...
	echo "<div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-2 h4 font-weight-normal'><b>Rodzaj pamięci:</b> $wynik[Rodzaj_Pamieci]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Pojemność całkowita:</b> $wynik[Pojemnosc]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Pojemność modułu:</b> $wynik[PojemnoscModulu]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Ilość modułów:</b> $wynik[IloscModulow]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Częstotliwość:</b> $wynik[Czestotliwosc]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Napięcie:</b> $wynik[Napiecie]</p>
...
$sql = "select * from ramy";
$query = mysqli_query($conn, $sql);
while($wynik = mysqli_fetch_assoc($query)){
	echo "<div class='col-md-12 col-sm-12 mr-0 ml-0'><a href='ramy.php?id=".$wynik['ID']."' class='text-decoration-none row border text-dark border-info shadow rounded mr-2 ml-2'>
         ...
         <div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-0'><b>Pojemność:</b> $wynik[Pojemnosc]</p>
            
			<p class='p-0 m-0'><b>Częstotliwość:</b> $wynik[Czestotliwosc]</p>
