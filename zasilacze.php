...
if(isset($_GET["id"])){
	...
	$sql = "select * from zasilacze where ID = '$id'";
	...
	echo "<div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-2 h4 font-weight-normal'><b>Typ:</b> $wynik[Standard]</p>
            
            <p class='p-0 m-2 h4 font-weight-normal'><b>Moc:</b> $wynik[Moc]</p>
			
            <p class='p-0 m-2 h4 font-weight-normal'><b>Wtyczki zasilania:</b> $wynik[WtyczkiZasilania]</p>
...
$sql = "select * from zasilacze";
$query = mysqli_query($conn, $sql);
while($wynik = mysqli_fetch_assoc($query)){
	echo "<div class='col-md-12 col-sm-12 mr-0 ml-0'><a href='zasilacze.php?id=".$wynik['ID']."' class='text-decoration-none row border text-dark border-info shadow rounded mr-2 ml-2'>
         ...
         <div class='col-md-12'>
          ...
          <div class='col-sm-6 pl-4 pr-0'>
            ...
            <p class='p-0 m-0'><b>Typ:</b> $wynik[Standard]</p>
            
            <p class='p-0 m-0'><b>Moc:</b> $wynik[Moc]</p>
